...
public class PageOfCustomerTaeOperation: APIModel {

    public var content: [CustomerTaeOperation]?
    ...
    public init(content: [CustomerTaeOperation]? = nil, empty: Bool? = nil, first: Bool? = nil, last: Bool? = nil, number: Int? = nil, numberOfElements: Int? = nil, pageable: Pageable? = nil, size: Int? = nil, sort: Sort? = nil, totalElements: Int? = nil, totalPages: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageOfCustomerTaeOperation else { return false }
    ...
    public static func == (lhs: PageOfCustomerTaeOperation, rhs: PageOfCustomerTaeOperation) -> Bool {
