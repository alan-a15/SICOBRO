...
extension JanoAPI.Autenticación {
    ...
    /**
    Permite consultar el timeout de sesión del dispositivo móvil
    */
    public enum IsActiveUsingGET1 {

        public static let service = APIService<Response>(id: "isActiveUsingGET_1", tag: "Autenticación", method: "GET", path: "/api/sales/session-timeout-in-seconds", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: IsActiveUsingGET1.service)
            }
