...
extension JanoAPI.Autenticación {
    ...
    /**
    Permite saber cuanto debe durar la sección de la web de ventas
    */
    public enum SessionTimeUsingGET {

        public static let service = APIService<Response>(id: "sessionTimeUsingGET", tag: "Autenticación", method: "GET", path: "/api/sales/session-time-in-minutes", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SessionTimeUsingGET.service)
            }
