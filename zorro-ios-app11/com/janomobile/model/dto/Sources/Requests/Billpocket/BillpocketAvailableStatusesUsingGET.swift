...
extension JanoAPI.Billpocket {
    ...
    */
    public enum BillpocketAvailableStatusesUsingGET {

        public static let service = APIService<Response>(id: "billpocketAvailableStatusesUsingGET", tag: "Billpocket", method: "GET", path: "/api/sales/billpocket/statuses", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BillpocketAvailableStatusesUsingGET.service)
            }
