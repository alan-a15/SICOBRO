...
extension JanoAPI.ConsultaVentas {
    ...
    */
    public enum FindByStoreAndDateRagePageableUsingGET {
        ...
        public static let service = APIService<Response>(id: "findByStoreAndDateRagePageableUsingGET", tag: "ConsultaVentas", method: "GET", path: "/api/sales/transactionsByDatePageable/{startDateString}/{endDateString}", hasBody: false)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = PageOfCustomerTaeOperation

            /** OK */
            case status200(PageOfCustomerTaeOperation)
            ...
            public var success: PageOfCustomerTaeOperation? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(PageOfCustomerTaeOperation.self, from: data))
