...
public class PageOfServicePaymentTransaction: APIModel {

    public var content: [ServicePaymentTransaction]?
    ...
    public init(content: [ServicePaymentTransaction]? = nil, empty: Bool? = nil, first: Bool? = nil, last: Bool? = nil, number: Int? = nil, numberOfElements: Int? = nil, pageable: Pageable? = nil, size: Int? = nil, sort: Sort? = nil, totalElements: Int? = nil, totalPages: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PageOfServicePaymentTransaction else { return false }
    ...
    public static func == (lhs: PageOfServicePaymentTransaction, rhs: PageOfServicePaymentTransaction) -> Bool {
