...
public class PrepareTxnRequest: APIModel {
    ...
    public init(amountDecimal: String? = nil, clientUUID: String? = nil, clientVersion: String? = nil, paymentReference: String? = nil, productTxnId: String? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PrepareTxnRequest else { return false }
    ...
    public static func == (lhs: PrepareTxnRequest, rhs: PrepareTxnRequest) -> Bool {
