...
extension JanoPaymentservicesAPI.Catálogos {
    ...
    Index
    */
    public enum IndexUsingGET {

        public static let service = APIService<Response>(id: "indexUsingGET", tag: "Catálogos", method: "GET", path: "/api/servicepayment/", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: IndexUsingGET.service)
            }
