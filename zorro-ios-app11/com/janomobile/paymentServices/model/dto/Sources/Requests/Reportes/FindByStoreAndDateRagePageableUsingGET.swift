...
extension JanoPaymentservicesAPI.Reportes {
    ...
    /**
    Consultar las transacciones PS en un periodo de tiempo por páginas, formato: ddMMyyyy
    */
    public enum FindByStoreAndDateRagePageableUsingGET {

        public static let service = APIService<Response>(id: "findByStoreAndDateRagePageableUsingGET", tag: "Reportes", method: "GET", path: "/api/servicepayment/transactionsByDatePageable/{startDateString}/{endDateString}", hasBody: false)
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: FindByStoreAndDateRagePageableUsingGET.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = PageOfServicePaymentTransaction

            /** OK */
            case status200(PageOfServicePaymentTransaction)
            ...
            public var success: PageOfServicePaymentTransaction? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(PageOfServicePaymentTransaction.self, from: data))
