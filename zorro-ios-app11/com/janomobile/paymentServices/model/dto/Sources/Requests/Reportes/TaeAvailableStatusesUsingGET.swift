...
extension JanoPaymentservicesAPI.Reportes {
    ...
    /**
    Regresa los estatus disponible para las operaciones SP
    */
    public enum TaeAvailableStatusesUsingGET {

        public static let service = APIService<Response>(id: "taeAvailableStatusesUsingGET", tag: "Reportes", method: "GET", path: "/api/servicepayment/statuses", hasBody: false)
